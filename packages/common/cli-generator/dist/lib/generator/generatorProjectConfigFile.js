 ...
 * @LastEditTime : 2020-05-13 17:48:23
 */
...
function generatorProjectConfigFile(generator) {
    return __awaiter(this, void 0, void 0, function () {
        var templatePath, templateData, targetPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generator.emit('gen_configFile_start');
                    templatePath = FILE_TPM_PATH + '/lartplus.config.tpl';
                    templateData = {
                        framework: generator.answers.framework,
...
exports.generatorProjectConfigFile = generatorProjectConfigFile;
