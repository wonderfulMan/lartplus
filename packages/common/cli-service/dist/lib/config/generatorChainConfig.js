 ...
 * @LastEditTime : 2020-06-03 16:45:23
 */
...
var createAssets_1 = require("./createAssets");
var createOptimization_1 = require("./createOptimization");
var GeneratorChainConfig = /** @class */ (function () {
    ...
    GeneratorChainConfig.prototype.setFrameworkRelatedToChain = function () {
        ...
        var FrameWorkService = require(modulePath).CreateConfig;
    ...
    GeneratorChainConfig.prototype.setGlobalPlugins = function () {
        new createAssets_1.CreateAssets(this.context, this.configChain).buildAll();
    };
    GeneratorChainConfig.prototype.setOptimization = function () {
        new createOptimization_1.CreateOptimization(this.context, this.configChain).buildAll();
    };
    /**
