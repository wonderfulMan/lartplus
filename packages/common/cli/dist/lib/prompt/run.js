 ...
 * @LastEditTime : 2020-01-26 13:00:02
 */
var InjectPrompt = /** @class */ (function () {
    function InjectPrompt() {
    }
    InjectPrompt.prototype.executePrompt = function () {
        return __awaiter(this, void 0, void 0, function () {
            var answer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cli_shared_utils_1.inquirer.prompt([
                            this.framwWork
                        ])];
                    case 1:
    ...
    ], InjectPrompt.prototype, "framwWork");
    __decorate([
        typedi_1.Inject(),
        __metadata("design:type", pwa_1["default"])
    ], InjectPrompt.prototype, "pwa");
    __decorate([
        typedi_1.Inject(),
        __metadata("design:type", linter_1["default"])
    ], InjectPrompt.prototype, "linter");
    InjectPrompt = __decorate([
        typedi_1.Service()
    ], InjectPrompt);
    return InjectPrompt;
}());
exports.InjectPrompt = InjectPrompt;
exports["default"] = InjectPrompt;
